...
class ToggleButton(BaseButton):
    ...
    def __init__(self, text: str = "", icon: QIcon = None, parent: QWidget = None):
        ...
        """
        super().__init__(text=text, icon=icon, component_name="ToggleButton", parent=parent)
        self._text_on = None
        self._text_off = None
        self._icon_on = None
        self._icon_off = None
...
class SubtleToggleButton(ToggleButton):
    """
    ...
    def __init__(self, text: str = "", icon: QIcon = None, parent: QWidget = None):
        ...
        self.setProperty("class", "SubtleToggleButton")
        PyLunixStyleSheet.TOGGLE_BUTTON.apply(self)
