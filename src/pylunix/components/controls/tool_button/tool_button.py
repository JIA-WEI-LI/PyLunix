...
class ToolButton(QToolButton):
    ...
    def __init__(self, icon: QIcon, parent: QWidget = None):
        ...
        self.isHover = False
        self._icon = icon if icon else QIcon()
    ...
    def _get_icon_color(self) -> str:
        return StateColorResolver.resolve("ToolButton", "Foreground", self, theme_type="TOOL_BUTTON")
...
class PrimaryToolButton(ToolButton):
    ...
    def _get_icon_color(self) -> str:
        return StateColorResolver.resolve("AccentToolButton", "Foreground", self, theme_type="TOOL_BUTTON")
# endregion 

# region ToggleToolButton
class ToggleToolButton(ToolButton):
    ...
    def _get_icon_color(self) -> str:
        prefix = "AccentToolButton" if self.isChecked() else "ToolButton"
        return StateColorResolver.resolve(prefix, "Foreground", self, theme_type="TOOL_BUTTON")
...
# region SubtleToolButton
class SubtleToolButton(ToolButton):
    """
    ...
    def __init__(self, icon: QIcon = None, parent: QWidget = None):
        super().__init__(icon=icon, parent=parent)
        self.setProperty("class", "SubtleToolButton")
# endregion

# region 

# region SubtleToggleToolButton
class SubtleToggleToolButton(ToggleToolButton):
    """
    A SubtleToolButton that also supports toggle states and dual icons.
    """
    pass
    def __init__(self, icon: QIcon = None, parent: QWidget = None):
        super().__init__(icon=icon, parent=parent)
        self.setProperty("class", "SubtleToggleToolButton")
# endregion